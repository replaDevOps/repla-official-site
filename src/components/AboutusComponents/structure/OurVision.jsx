            ...
            <Row gutter={[64, 24]} align={'middle'}>
                <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 12 }} lg={{ span: 12 }}>
                    <Flex vertical gap={20}>
                        <Title level={1} className='head-font fw-700 text-white m-0'>Our Vision</Title>
                ...
                <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 12 }} lg={{ span: 12 }}>
                    <Flex justify='end'>
                        <Image src="assets/images/vision.svg" preview={false} width={'70%'} className='rounded-12' alt="" />
                    </Flex>
                </Col>
            </Row>
        </div>
