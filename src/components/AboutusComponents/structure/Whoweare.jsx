          ...
          <Col lg={12} md={24} xs={24} sm={24}>
            <Space direction="vertical" size={30}>
              ...
              <Flex vertical gap={20}>
                ...
                <Text className="text-white fw-400 para-font fs-18">
                  {t('Our team of developers, designers, and innovators are located across the globe, ensuring that we can deliver exceptional solutions to our clients.')}
                </Text>
              </Flex>
              <Button type="primary" className="metaverse-btn">
                <span className="metaverse-btn-text">{t("Let's Start")}</span>
