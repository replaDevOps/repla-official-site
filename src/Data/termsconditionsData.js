export const getTermsConditionsData = (t) => ({
  title: t('TERMS AND CONDITIONS'),
  desc: t(`Repla is an online platform operator that holds a legal business license of the
  ...
  listdoc: [
    {
      title: t('TRANSACTION AGREEMENT'),
      list: [
        { text: t(`In order to avoid disputes when betting on this website, members must read the rules set
        ...
        { text: t(`Please modify your login password and fund password regularly. Members are responsible
        ...
        { text: t(`If it is discovered by this platform that a member has made bets by improper methods
        ...
        { text: t(`If this platform finds that a member has repeatedly applied for an account, it reserves the
          ...
          on this platform.`) },
        { text: t(`The platform customer service does not have any QQ or other contact information. The
        ...
        { text: t(`All recharge accounts on the platform are changed from time to time. Please be sure to
        ...
        { text: t(`Repla will ask the client to provide supporting documents when necessary to verify
    ...
    {
      title: t('BETTING RELATED TERMS'),
      list: [
        { text: t(`If online betting is not successfully submitted, the bet will be considered invalid.`) },
        { text: t(`When the client is automatically or forcibly disconnected during the draw and
          there is no result, it will not affect the result of the draw settlement.`) },
        { text: t(`If there is no prize draw on the official website or the result of the draw is wrong,
          the platform will refund the prize or purchase according to the actual situation.`) },
        { text: t(`In the event of irresistible disasters, hacker intrusions, or network problems
          causing data loss, the announcement on this platform is the final plan.`) },
        { text: t(`This platform will record all electronic transactions. If there is any dispute, this
          platform will take the betting record as the standard.`) },
      ],
    },
    {
      title: t('LIABILITY STATEMENT'),
      list: [
        { text: t(`Any operation performed after logging in with the account and password on this platform
        ...
        { text: t(`This platform uses "web-based online customer service" as the only way to provide users
          ...
          this.`) },
        { text: t(`This platform recommends that users perform important operations such as personal
        ...
        { text: t(`The mailbox bound by the user on this platform must be true and valid; once the mailbox
        ...
        { text: t(`This platform reserves the right to interpret and correct other unexplained matters or
          disputes.`) },
      ],
    },
  ],
